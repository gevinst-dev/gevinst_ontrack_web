...
if (file_exists(APPPATH.'config/app-config.php')) {
    ...
    //die("app-config.php file is missing.");
}
...
$config['csrf_token_name'] = 'csrf_cirdk_token';
$config['csrf_cookie_name'] = 'csrf_cirdk_cookie';
$config['csrf_expire'] = 86400;
$config['csrf_regenerate'] = FALSE;
$config['csrf_exclude_uris'] = array('admin/filemanager/connector');
