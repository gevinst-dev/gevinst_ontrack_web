        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php echo form_open(base_url('admin/auth/sign_in'), 'data-toggle="validator" class="md-float-material form-material"');  ?>
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-md-12">
                                        ...
                                        <div class="forgot-phone text-right float-right">
                                            <a href="<?= base_url()?>admin/auth/forgot_password" class="text-right f-w-600"> <?= __('Forgot Password?') ?></a>
                                        </div>
                                    </div>
                                </div>
