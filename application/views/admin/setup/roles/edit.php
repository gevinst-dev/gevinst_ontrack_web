            ...
            <div class="col-sm-6">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!"><?= __('Edit Role') ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        ...
                        <?php if($role['name'] != "Super Administrator") {  ?>
                            <?= form_open('admin/setup/roles/edit/'.$role['id'], 'data-toggle="validator"'); ?>
                                ...
                                <div class="card-block text-right">
                                    <button type="submit" class="btn btn-success waves-effect waves-light "><?= __("Save Role") ?></button>
                                </div>
                        ...
                        <?php } else { ?>
                            ...
                            <div class="card-block">
                                <p class="alert alert-warning"><?= __('The Super Administrator role cannot be edited.') ?></p>
                            </div>
