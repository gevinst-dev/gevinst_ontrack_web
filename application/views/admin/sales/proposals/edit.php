                ...
                <div class="text-right">
                    ...
                    <div class="dropdown-primary dropdown open">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                            <a href="<?= base_url('admin/sales/proposals/pdf/view/'.$proposal['id']) ?>" class="dropdown-item waves-light waves-effect" target="_blank"><i class="far fa-fw fa-file-pdf"></i> <?= __('View') ?></a>
                            <a href="<?= base_url('admin/sales/proposals/pdf/download/'.$proposal['id']) ?>" class="dropdown-item waves-light waves-effect"><i class="far fa-fw fa-file-pdf"></i> <?= __('Download') ?></a>

                        </div>
                    </div>
                    <button data-modal="admin/sales/proposals/send_email/<?= $proposal['id']; ?>" class="btn btn-primary btn-md waves-effect waves-light"><i class="fas fa-fw fa-envelope"></i> <?= __('Email') ?></button>



                    <button data-modal="admin/sales/proposals/generate_proforma/<?= $proposal['id']; ?>" class="btn btn-inverse btn-md waves-effect waves-light"><?= __('Generate Proforma') ?></button>
                    <button data-modal="admin/sales/proposals/generate_invoice/<?= $proposal['id']; ?>" class="btn btn-inverse btn-md waves-effect waves-light"><?= __('Generate Invoice') ?></button>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <?= form_open(base_url('admin/sales/proposals/edit/'.$proposal['id'])); ?>
                                <div class="row">


                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class=""><?= __("Proposal Number") ?></label>
                                            <input type="text" class="form-control" name="number" value="<?= $proposal['number']; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="entity_id" required>
                                                <?php foreach ($entities as $entity) { ?>
                                                    <option value="<?php echo $entity['id']; ?>" <?php if($proposal['entity_id'] == $entity['id']) echo "selected"; ?> ><?php echo $entity['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class=""><?php _e('Client / Lead'); ?></label>
                                            <select class="form-control select2_clients_leads" name="client_id" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="date" id="datepicker" value="<?php echo date_display($proposal['date']); ?>" required>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="valid_until" value="<?php echo date_display($proposal['valid_until']); ?>" id="datepicker2">
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="added_by" required>
                                                <?php foreach ($staff as $item) { ?>
                                                    <option value="<?php echo $item['id']; ?>" <?php if($proposal['added_by'] == $item['id']) echo "selected"; ?> ><?php echo $item['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="language_id" required>
                                                <?php foreach ($languages as $language) { ?>
                                                    <option value="<?php echo $language['id']; ?>" <?php if($proposal['language_id'] == $language['id']) echo "selected"; ?> ><?php echo $language['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" name="status" required>
                                                <option value="Draft" <?php if($proposal['status'] == "Draft") echo "selected"; ?> ><?= __("Draft") ?></option>
                                                <option value="Sent" <?php if($proposal['status'] == "Sent") echo "selected"; ?> ><?= __("Sent") ?></option>
                                                <option value="Accepted" <?php if($proposal['status'] == "Accepted") echo "selected"; ?> ><?= __("Accepted") ?></option>
                                                <option value="Canceled" <?php if($proposal['status'] == "Canceled") echo "selected"; ?> ><?= __("Canceled") ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" step="any" class="form-control" name="rate" id="exrate" value="<?= $proposal['rate'] ?>">
                                                <span class="help-block with-errors messages text-danger"></span>
                                            </div>
                                        </div>
                                    <?php } ?>
                                                ...
                                                <?php foreach($proposal_items as $item) { ?>
                                                    <tr class="entry">
                                                        <td>
                                                            ...
                                                            <input type="text" class="form-control" name="items[name][]" id="item_name" value="<?= $item['name']; ?>">
                                                        </td>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class=""><?= __("Proposal Text") ?></label>
                                            <textarea name="offer_text" class="form-control" id="tinymceinputX"><?php echo $proposal['offer_text']; ?></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" class="form-control" id="tinymceinputX"><?php echo $proposal['notes']; ?></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light "><?= __("Save Proposal") ?></button>
                                    </div>
