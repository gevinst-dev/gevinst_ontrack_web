<div class="modal-content">
    <?= form_open(base_url('admin/sales/proposals/generate_proforma/'.$proposal['id']), 'id="modal-form"'); ?>
        ...
        <div class="modal-body">
            ...
            <p><?= __("Are you sure you want to generate a proforma for the following proposal?") ?></p>
