                        ...
                        <div class="card-block">
                            ...
                            <?= form_open(NULL); ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class=""><?= __("Valid Until") ?></label>
                                            <input type="text" class="form-control" name="valid_until" id="datepicker2" value="<?php echo date_display(date('Y-m-d', time() + 2592000)); ?>">
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class=""><?= __("Proposal Text (Public)") ?></label>
                                            <textarea name="offer_text" class="form-control" id="tinymceinputX" rows="10"><?= get_setting('proposal_text'); ?></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class=""><?= __("Notes (Private)") ?></label>
                                            <textarea name="notes" class="form-control" id="tinymceinputX" rows="10"></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light "><?= __("Add Proposal") ?></button>
                                    </div>
