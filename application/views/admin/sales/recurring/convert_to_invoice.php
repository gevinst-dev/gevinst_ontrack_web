<div class="modal-content">
    <?= form_open(base_url('admin/sales/proposals/convert_to_invoice/'.$proposal['id']), 'id="modal-form"'); ?>
        ...
        <div class="modal-body">
            ...
            <p><?= __("Are you sure you want to convert the following proposal to invoice?") ?></p>
