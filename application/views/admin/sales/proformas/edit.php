        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="text-right">
                    <a href="<?= base_url('admin/sales/proformas/pdf/view/'.$proforma['id']); ?>" class="btn btn-primary btn-md waves-effect waves-light" target="_blank"><i class="fas fa-fw fa-print"></i> <?= __('Print') ?></a>
                    <a href="<?= base_url('admin/sales/proformas/pdf/download/'.$proforma['id']); ?>" class="btn btn-primary btn-md waves-effect waves-light" target="_blank"><i class="fas fa-fw fa-download"></i> <?= __('Download') ?></a>

                    <button data-modal="admin/sales/proformas/send_email/<?= $proforma['id']; ?>" class="btn btn-primary btn-md waves-effect waves-light"><i class="fas fa-fw fa-envelope"></i> <?= __('Email') ?></button>
                ...
                <div class="page-body">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <?= form_open(base_url('admin/sales/proformas/edit/'.$proforma['id'])); ?>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="number" value="<?= $proforma['number']; ?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="entity_id" required>
                                                <?php foreach ($entities as $entity) { ?>
                                                    <option value="<?php echo $entity['id']; ?>" <?php if($proforma['entity_id'] == $entity['id']) echo "selected"; ?> ><?php echo $entity['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="date" id="datepicker" value="<?php echo date_display($proforma['date']); ?>" required>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="due_date" value="<?php echo date_display($proforma['due_date']); ?>" id="datepicker2" required>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="added_by" required>
                                                <?php foreach ($staff as $item) { ?>
                                                    <option value="<?php echo $item['id']; ?>" <?php if($proforma['added_by'] == $item['id']) echo "selected"; ?> ><?php echo $item['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="status" required>
                                                    <option value="Valid" <?php if($proforma['status'] == "Valid") echo "selected"; ?> ><?php _e('Valid'); ?></option>
                                                    <option value="Draft" <?php if($proforma['status'] == "Draft") echo "selected"; ?> ><?php _e('Draft'); ?></option>
                                                    <option value="Canceled" <?php if($proforma['status'] == "Canceled") echo "selected"; ?> ><?php _e('Canceled'); ?></option>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="language_id" required>
                                                <?php foreach ($languages as $language) { ?>
                                                    <option value="<?php echo $language['id']; ?>" <?php if($proforma['language_id'] == $language['id']) echo "selected"; ?> ><?php echo $language['name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" step="any" class="form-control" name="rate" id="exrate" value="<?= $proforma['rate'] ?>">
                                                <span class="help-block with-errors messages text-danger"></span>
                                            </div>
                                        </div>
                                    <?php } ?>
                                            ...
                                            <tbody class="entries">
                                                <?php foreach($proforma_items as $item) { ?>
                                                    <tr class="entry">
                                                        ...
                                                        <td>
                                                            <input type="number" step="any" class="form-control item_price onchange-update-totals" name="items[price][]" id="item_price" required  value="<?= $item['price']; ?>" placeholder="Pret Net">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="public_notes" class="form-control" id="tinymceinputX"><?php echo $proforma['public_notes']; ?></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="private_notes" class="form-control" id="tinymceinputX"><?php echo $proforma['private_notes']; ?></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light "><?= __("Save proforma") ?></button>
                                    </div>
