                        ...
                        <div class="card-block">
                            ...
                            <table class="hidden">
                                <tr class="templateEntry hidden">
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control item_price onchange-update-totals" name="items[price][]" id="item_price" required placeholder="Pret Net">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="due_date" id="datepicker2" required>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <?php } else { ?>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" step="any" class="form-control" name="rate" id="exrate" value="<?= exrate_latest($currency['id']); ?>">
                                                <span class="help-block with-errors messages text-danger"></span>
                                            </div>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="public_notes" class="form-control" id="tinymceinputX"></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="private_notes" class="form-control" id="tinymceinputX"></textarea>
                                            <span class="help-block with-errors messages text-danger"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary waves-effect waves-light "><?= __("Add Proforma") ?></button>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.select2_clients').on('select2:select', function (e) {
            var client_id = e.params.data.id;

            $.get("<?= base_url('admin/json/client_overcredit/') ?>"+client_id, function(data, status) {
                if(data == '1') {
                    alert('Atentie! Acest client a depasit limita de credit.');
                }
