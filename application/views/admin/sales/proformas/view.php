<div class="modal-content">
        ...
        <div class="modal-footer">
            <a href="<?= base_url('admin/sales/proformas/pdf/view/'.$proforma['id']); ?>" class="btn btn-primary waves-effect" target="_blank"><i class="fas fa-fw fa-print"></i> <?= __('Print') ?></a>
            <a href="<?= base_url('admin/sales/proformas/pdf/download/'.$proforma['id']); ?>" class="btn btn-primary waves-effect" target="_blank"><i class="fas fa-fw fa-download"></i> <?= __('Download') ?></a>
