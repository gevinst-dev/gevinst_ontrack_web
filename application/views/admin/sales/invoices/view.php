<div class="modal-content">
            ...
            <table class="table table-bordered controls" id="customDataTable">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>
                            <?= $currency['prefix'] ?><span id="text_totals_value"><?= $invoice['value']; ?></span><?= $currency['suffix'] ?>
                        </th>
                        <th>
                            <?= $currency['prefix'] ?><span id="text_totals_tax"><?= $invoice['tax']; ?></span><?= $currency['suffix'] ?>
                        </th>
                        <th>
                            <?= $currency['prefix'] ?><span id="text_totals_total"><?= $invoice['total']; ?></span><?= $currency['suffix'] ?>
                        </th>
                    </tr>
                </tfoot>
        ...
        <div class="modal-footer">
            <a href="<?= base_url('admin/sales/invoices/pdf/view/'.$invoice['id']); ?>" class="btn btn-primary waves-effect" target="_blank"><i class="fas fa-fw fa-print"></i> <?= __('Print') ?></a>
            <a href="<?= base_url('admin/sales/invoices/pdf/download/'.$invoice['id']); ?>" class="btn btn-primary waves-effect" target="_blank"><i class="fas fa-fw fa-download"></i> <?= __('Download') ?></a>
