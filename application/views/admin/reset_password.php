        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <?php echo form_open(base_url('admin/auth/reset_password/'.$key), 'data-toggle="validator" class="md-float-material form-material"');  ?>
                            ...
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        ...
                                        <br>
                                        <p class="text-center"><?= __('Enter new password.') ?></p>
                                    </div>
                                </div>

                                <div class="form-group form-primary">
                                    <input type="password" name="password" id="password" class="form-control" data-minlength="8" required>
                                ...
                                <div class="form-group form-primary">
                                    <input type="password" name="password_confirm" class="form-control" data-match="#password" required>
                                    <span class="form-bar"></span>
