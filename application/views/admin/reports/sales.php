                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2 onchange-submit" name="filter_invoice_status" required>
                                    <option value=""><?= __('- All Invoice Statuses -') ?></option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2 onchange-submit" name="filter_payment_status" required>
                                    <option value=""><?= __('- All Payment Statuses -') ?></option>
                                
                                    <option value="Paid" <?php if($this->session->filter_payment_status == 'Paid') echo "selected"; ?> ><?= __('Paid'); ?></option>
                                    <option value="Unpaid + Partially Paid" <?php if($this->session->filter_payment_status == 'Unpaid + Partially Paid') echo "selected"; ?> ><?= __('Unpaid + Partially Paid'); ?></option>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($items as $item) { ?>
                                            <tr>
                                                ...
                                                <td data-sort="<?= $item['due_date']; ?>"><?= date_display($item['due_date']); ?></td>
