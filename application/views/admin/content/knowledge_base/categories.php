        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="text-right">
                    ...
                    <button data-modal="admin/content/knowledge_base/add_category" class="btn btn-primary btn-md waves-effect waves-light"><?= __('Add Category') ?></button>
                    <?php } ?>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-pills nav-fill card-header-pills">
                                <li class="nav-item">
                                    <a class="nav-link " href="<?= base_url('admin/content/knowledge_base/articles'); ?>" ><?= __('Articles') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<?= base_url('admin/content/knowledge_base/categories'); ?>" ><?= __('Categories') ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#DataTables-SS').DataTable({
            ...
            "fixedHeader": true,
            "ajax": {
                "url": "<?= base_url(); ?>admin/content/knowledge_base/json_all_categories",
                "type": "POST",
                data: function ( d ) {
