                ...
                <div class="row">
                    <div class="col-xs-4">
                        <h1 class="text-uppercase"><?= __p("PROPOSAL",$l_id); ?></h1>
                    </div>
                    <div class="col-xs-4 text-center">

                        <?= __p("Number",$l_id); ?> <b><?= $data['invoice']['number']; ?></b><br>
                        <?= __p("Date",$l_id); ?> <b><?= date_display($data['invoice']['date']); ?></b><br>
                        <?php if($data['invoice']['valid_until'] != "") { ?>
                            <?= __p("Valid Until",$l_id); ?> <b><?= date_display($data['invoice']['valid_until']); ?></b><br>
                        <?php } ?>
                ...
                <div class="row">
                    ...
                    <?php if($data['invoice']['status'] == "Canceled") { ?>
                        <div class="col-xs-12 text-center">
                            <h1 class="text-red text-uppercase text-danger"><?= __p("CANCELED",$l_id); ?></h1>
                        </div>
                    <?php } ?>
