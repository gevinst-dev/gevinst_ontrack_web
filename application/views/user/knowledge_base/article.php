                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h5><?= html_escape($article['name']) ?> <small><a class="f-13 text-muted" href="<?= base_url('knowledge_base/category/'.$article['category_id']); ?>"><?= get_kb_category_name($article['category_id']); ?></a></small></h5>
                            </div>

                            <div class="card-block">


                                <?= purify($article['content']) ?>
